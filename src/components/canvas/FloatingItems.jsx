...
export default function FloatingIntems() {
  ...
  const meshRef28 = useRef();
  const meshRef29 = useRef();
  const meshRef30 = useRef();
  const meshRef31 = useRef();

  const google = useLoader(THREE.TextureLoader, "../src/assets/google.png");
  const wp = useLoader(THREE.TextureLoader, "../src/assets/wp.png");
  // const eth = useLoader(THREE.TextureLoader, "../src/assets/eth.png");
  const linkedin = useLoader(THREE.TextureLoader, "../src/assets/linkedin.png");
  const react = useLoader(THREE.TextureLoader, "../src/assets/react.svg");
  const insta = useLoader(THREE.TextureLoader, "../src/assets/insta.png");
  const face = useLoader(THREE.TextureLoader, "../src/assets/face.png");
  const reddit = useLoader(THREE.TextureLoader, "../src/assets/reddit.png");
  const vimeo = useLoader(THREE.TextureLoader, "../src/assets/vimeo.png");
  const snapchat = useLoader(THREE.TextureLoader, "../src/assets/snapchat.png");
  const whatsapp = useLoader(THREE.TextureLoader, "../src/assets/whatsapp.png");
  const youtube = useLoader(THREE.TextureLoader, "../src/assets/youtube.png");
  const skype = useLoader(THREE.TextureLoader, "../src/assets/skype.png");
  const twitter = useLoader(THREE.TextureLoader, "../src/assets/twitter.png");
  const pinterest = useLoader(THREE.TextureLoader, "../src/assets/pinterest.png");
  const discord = useLoader(THREE.TextureLoader, "../src/assets/discord.png");
  const behance = useLoader(THREE.TextureLoader, "../src/assets/behance.png");
  const dribble = useLoader(THREE.TextureLoader, "../src/assets/dribble.png");
  const analytics = useLoader(THREE.TextureLoader, "../src/assets/analytics.png");
  const chatgpt = useLoader(THREE.TextureLoader, "../src/assets/chatgpt.png");
  const hubspot = useLoader(THREE.TextureLoader, "../src/assets/hubspot.png");
  const saleforce = useLoader(THREE.TextureLoader, "../src/assets/salesforce.png");
  ...
  useFrame((state) => {
    ...
    meshRef28.current.rotation.y = state.clock.getElapsedTime() * 1; 
    meshRef29.current.rotation.y = state.clock.getElapsedTime() * 1; 
    meshRef30.current.rotation.y = state.clock.getElapsedTime() * 1; 
    meshRef31.current.rotation.y = state.clock.getElapsedTime() * 1; 
  });

  return (
    <>
      {/* google */}
      <mesh position={[0, 0.1, 0]}  ref={meshRef1} >
        <cylinderGeometry
      ...
      {/* reddit */}
      <mesh position={[0, -0.4, 0]} ref={meshRef2} >
        <cylinderGeometry
      ...
      {/* facebook */}
      <mesh position={[0, 0.01, 0]} ref={meshRef3} >
        <cylinderGeometry
      ...
      {/* twitter */}
      <mesh position={[0, -0.1, 0]}  ref={meshRef14}>
        <cylinderGeometry
      ...
      {/* behance */}
      <mesh position={[0, -0.1, 0]} ref={meshRef17}>
        <cylinderGeometry
      ...
      <mesh position={[0, -0.1, 0]}  ref={meshRef18}>
       ...
       {/* chatgpt */}
       <mesh position={[0, -0.1, 0]}  ref={meshRef28}>
        <cylinderGeometry
          args={[1.11614, 1.11614, 0.2, 40, 55, true, 5, 0.2]}
          radialSegments={30}
        />
    ...
    {/* analytics */}
    <mesh position={[0, -0.1, 0]}  ref={meshRef29}>
        <cylinderGeometry
          args={[1.11614, 1.11614, 0.2, 40, 55, true, 5, 0.2]}
          radialSegments={30}
        />
      ...
      {/* hubspot */}
    <mesh position={[0, -0.1, 0]}  ref={meshRef30}>
        <cylinderGeometry
          args={[1.11614, 1.11614, 0.2, 40, 55, true, 5, 0.2]}
          radialSegments={30}
        />
 ...
 {/* salesforce */}
 <mesh position={[0, -0.1, 0]}  ref={meshRef31}>
        <cylinderGeometry
          args={[1.22614, 1.22614, 0.2, 40, 55, true, 5, 0.2]}
          radialSegments={30}
        />
        <meshStandardMaterial
          color={"#FFFFFF"}
      ...
      <mesh position={[0, -0.007, 0]}  ref={meshRef21} >
        <cylinderGeometry
      ...
      <mesh position={[0, -0.15, 0]}  ref={meshRef22} >
        <cylinderGeometry
...
{/* 
      <mesh position={[0, -0.2, 0]}  ref={meshRef23} >
        <cylinderGeometry
          args={[1.083441, 1.08441, 0.185, 22, 5, true, 4.89, 0.5]}
          radialSegments={10}
        />
